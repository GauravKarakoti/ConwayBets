...
function App() {
  ...
  const { markets, loading, error, hasMore, loadMore } = useMarkets({
    filter: {
      search: searchQuery,
  ...
  const handleCreateMarket = async (e: React.FormEvent) => {
    e.preventDefault();
    // Implementation for market creation
                  ...
                  {markets.map((market) => (
                    <div key={market.id} className="market-card">
                      ...
                      <div className="market-meta">
                        ...
                        <span className="meta-item">
                          Liquidity: {formatCurrency(market.totalLiquidity)} TEST
                        </span>
                      </div>
                          ...
                          <div key={index} className="outcome-row">
                            ...
                            <div className="outcome-actions">
                              ...
                              <button
                                ...
                                onClick={() => handlePlaceBet(market.id, index, '10')}
                              >
                                Bet
                              </button>
                            </div>
            ...
            <div className="create-tab">
              ...
              <form onSubmit={handleCreateMarket} className="create-market-form">
                ...
                <div className="form-actions">
                  <button type="submit" className="create-market-button">
                    Create Market
                  </button>
                  <button
                    type="button"
